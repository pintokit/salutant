class SubmissionsController < ApplicationController
  ...
  private
    ...
    def selected_headers
      headers = ['HTTP_VIA', 'HTTP_HOST', 'HTTP_ACCEPT', 'HTTP_REFERER', 'HTTP_VERSION', 'HTTP_CONNECTION', 'HTTP_USER_AGENT', 'HTTP_CONNECT_TIME', 'HTTP_X_REQUEST_ID', 'HTTP_ACCEPT_ENCODING', 'HTTP_ACCEPT_LANGUAGE', 'HTTP_X_FORWARDED_FOR', 'HTTP_X_REQUEST_START', 'HTTP_TOTAL_ROUTE_TIME', 'HTTP_X_FORWARDED_PORT', 'HTTP_X_FORWARDED_PROTO', 'ORIGIN', 'GATEWAY_INTERFACE', 'QUERY_STRING', 'REMOTE_ADDR', 'REQUEST_URI', 'SERVER_NAME', 'SERVER_PORT', 'SERVER_SOFTWARE', 'SERVER_PROTOCOL']
